	...
	CREATE TABLE `RelMedicinesPets` (
		`idMedicinePet` bigint NOT NULL AUTO_INCREMENT,
		`idMedicine` bigint NOT NULL,
		`idPet` bigint NOT NULL,
		`quantity` int NOT NULL,
		`status` bigint NOT NULL,
		PRIMARY KEY (`idMedicinePet`)
	);
	...
	ALTER TABLE `RelMedicinesPets` ADD CONSTRAINT `RelMedicinesPets` UNIQUE(`idMedicine`, `idPet`, `status`);
